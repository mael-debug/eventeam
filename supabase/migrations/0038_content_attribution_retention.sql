-- Corrige content_attribution.retained_at_horizon / retention_rate, insérés
-- en dur à null depuis le lot 5 (stub jamais terminé — les 174 lignes
-- existantes en base n'ont donc jamais eu de rétention calculée, ce qui
-- affichait "non calculé" sur l'écran Contenu quel que soit l'import).
--
-- Même méthode que acquisition_spikes.retention_rate (0017) et
-- custom_window_stats (0037) : part des arrivées de la fenêtre (ici 48h
-- après publication) encore au statut 'present' aujourd'hui. Le reste de
-- recompute_account() est repris à l'identique — seule la section 7 change.
