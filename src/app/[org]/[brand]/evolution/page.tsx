    ...
    <main style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 1280, minWidth: 0 }}>
      ...
      {anyFrozen && (
        <div style={{ background: "var(--pastel-jaune)", borderRadius: 18, padding: "16px 20px", fontSize: 14, color: "var(--encre)", lineHeight: 1.5 }}>
          Certains chiffres Meta (abonnés, gagnés, perdus, genre) sont identiques entre deux imports rapprochés —
          repérable dans le tableau plus bas. Espacez vos exports d&apos;au moins un mois pour un suivi fiable de ces
          chiffres. Les courbes ci-dessous n&apos;en dépendent pas.
        </div>
      )}
